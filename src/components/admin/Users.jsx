...
//                       <span style={styles.detailValue}>{user.mobile || "N/A"}</span>
//                     </div>
//                     <div style={styles.detailRow}>
...
//                         <span style={styles.detailValue} title={user.address}>
...
//                 <div style={isMobile ? styles.fullWidth : styles.fullWidthDesktop}>
