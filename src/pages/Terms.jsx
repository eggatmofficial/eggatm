...
const Terms = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      {/* Inline animation CSS (single file) */}
      <style>
        {`
          @keyframes fadeUp {
      ...
      {/* Header */}
      <div className="relative overflow-hidden bg-gradient-to-r from-yellow-400 to-orange-500 py-16 text-center animate-fade-down">
        <div className="absolute inset-0 bg-black/10" />

        <FaFileContract className="relative mx-auto text-6xl text-white mb-4 drop-shadow-lg animate-scale-in" />
        <h1 className="relative text-4xl md:text-5xl font-extrabold text-white tracking-wide">
          Terms & Conditions
        </h1>
        <p className="relative text-white/90 mt-3 max-w-xl mx-auto">
      ...
      {/* Content */}
      <div className="max-w-5xl mx-auto px-4 py-14">
        <div className="bg-white rounded-2xl shadow-xl p-6 md:p-10 space-y-10 animate-fade-up">

          {/* Section 1 */}
          <section className="group border-l-4 border-yellow-400 pl-6 py-3 rounded-lg transition-all hover:bg-yellow-50/40 hover:translate-x-1">
            <h2 className="text-2xl font-semibold text-gray-800 mb-3">
              1. Acceptance of Terms
            </h2>
            <p className="text-gray-600 leading-relaxed">
